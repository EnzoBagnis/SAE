...
<body<?php echo $isLoggedIn ? ' class="logged-in"' : ''; ?>>
    ...
    <div class="legal-container">
        ...
        <section class="legal-section">
            ...
            <p>
                Les données collectées sur ce site sont utilisées uniquement dans le cadre du service proposé
        ...
        <section class="legal-section">
            <h2>5. Cookies</h2>
            <p>
                Ce site utilise des cookies techniques nécessaires à son bon fonctionnement, notamment pour
        ...
        <section class="legal-section">
            ...
            <p>
                ...
                sites et/ou de pages personnelles et d'une manière générale vers toutes ressources existantes
        ...
        <section class="legal-section">
            ...
            <p>
                Le présent site et les mentions légales sont régis par le droit français. En cas de litige
                et à défaut d'accord amiable, le litige sera porté devant les tribunaux français conformément
