...
<body>
    <div class="page-wrap">
        <a href="<?= BASE_URL ?>/index.php" class="back-arrow" title="Retour ├á l'accueil">
        ...
        <div class="card" style="text-align: center;">
            ...
            <div class="verification-content">
                ...
                <p style="margin-bottom: 25px;">Vous recevrez un email une fois votre compte activ├® pour pouvoir vous connecter.</p>

                <div class="actions">
                    <a href="<?= BASE_URL ?>/index.php?action=login" class="btn btn-primary" style="display: inline-block; text-decoration: none;">Retour ├á la connexion</a>
                </div>
            </div>
        </div>
    </div>
